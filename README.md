...
These are the languages that I studied or I'm studying:
- Spanish: Native
- English: C1
- Japanese: N5, currently going to N4 (it's not much, but it's honest work I tell ya!)
...
**Technologies:**  
`Java 11` `Kotlin` `Spring Boot` `React.js` `TypeScript` `PostgreSQL` `AWS` `JUnit 5` `WireMock` `OpenSearch` `SonarQube`
...
#### 🏢 Connectis ICT Services
**Fullstack Java Developer**  
📅 January 2019 - December 2020  

- Development and maintenance of microservices for an Argentine banking institution  
- Work within a self-managed Scrum team  
- Participation in team formation initiatives (The Core)  

**Technologies:**  
`Java 8/11` `Spring Boot` `Spring Data` `Spring MVC` `PostgreSQL` `Grafana` `Vue.js` `jQuery`
...
- Backend development using Java and Grails  
- Report generation with JasperReports  
- Work in enterprise environments (WebSphere, Citrix)  

**Technologies:**  
`Java` `Grails` `Spring` `PostgreSQL` `IBM WebSphere`
